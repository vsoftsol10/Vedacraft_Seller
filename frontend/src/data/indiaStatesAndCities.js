// Source: dr5hn/countries-states-cities-database v3.2-export.7, json-countries+states+cities.json.gz; fetched 2026-09-23.
// Static build-time dataset only; refresh from the upstream release when needed.
...
export default INDIA_STATES_AND_CITIES;
